...
ROLE_SKILL_ASSIGNMENTS = {
    ...
    "Gatareba.ge": {
        ...
        "Operations Manager": ["gatareba-compliance-ops"],
        "Finance & Risk Manager": ["gatareba-compliance-ops"],
        "Product & Tech Manager": ["gatareba-compliance-ops"],
    ...
    "Lovkode.no": {
        "CEO": ["lovkode-matter-platform"],
        "Operations Manager": ["lovkode-matter-platform"],
        "Finance & Risk Manager": ["lovkode-matter-platform"],
        "Product & Tech Manager": ["lovkode-matter-platform"],
        "Customer Service Manager": ["lovkode-matter-platform", "humanize-klarsprak"],
    },
    "Parallel Company AI": {
    ...
    "EmDash Sidecar SaaS": {
        "CEO": ["host-sidecar-rollout", "quality-gates", "deployed-url-audit"],
        "Operations Manager": ["host-sidecar-rollout", "quality-gates"],
        "Product & Tech Manager": ["design-clone", "design-import", "host-sidecar-rollout", "quality-gates"],
        "Growth & Revenue Manager": ["publishing", "draft-gen", "deployed-url-audit"],
